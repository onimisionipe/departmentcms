...
Xinha.Config = function()
{
 ...
 /** You can tell the fullscreen mode to leave certain margins on each side.<br />
  ...
  this.btnList =
  {
    bold: [ "Bold", Xinha._lc({key: 'button_bold', string: ["ed_format_bold.gif",-1,-1]}, 'Xinha'), false, function(e) { e.execCommand("bold"); } ],
    italic: [ "Italic", Xinha._lc({key: 'button_italic', string: ["ed_format_italic.gif",-1,-1]}, 'Xinha'), false, function(e) { e.execCommand("italic"); } ],
    underline: [ "Underline", Xinha._lc({key: 'button_underline', string: ["ed_format_underline.gif",-1,-1]}, 'Xinha'), false, function(e) { e.execCommand("underline"); } ],
    strikethrough: [ "Strikethrough", Xinha._lc({key: 'button_strikethrough', string: ["ed_format_strike.gif",-1,-1]}, 'Xinha'), false, function(e) { e.execCommand("strikethrough"); } ],
    subscript: [ "Subscript", Xinha._lc({key: 'button_subscript', string: ["ed_format_sub.gif",-1,-1]}, 'Xinha'), false, function(e) { e.execCommand("subscript"); } ],
    superscript: [ "Superscript", Xinha._lc({key: 'button_superscript', string: ["ed_format_sup.gif",-1,-1]}, 'Xinha'), false, function(e) { e.execCommand("superscript"); } ],

    justifyleft: [ "Justify Left", ["ed_align_left.gif",-1,-1], false, function(e) { e.execCommand("justifyleft"); } ],
    justifycenter: [ "Justify Center", ["ed_align_center.gif",-1,-1], false, function(e){ e.execCommand("justifycenter"); } ],
    justifyright: [ "Justify Right", ["ed_align_right.gif",-1,-1], false, function(e) { e.execCommand("justifyright"); } ],
    justifyfull: [ "Justify Full", ["ed_align_justify.gif",-1,-1], false, function(e) { e.execCommand("justifyfull"); } ],

    orderedlist: [ "Ordered List", ["ed_list_num.gif",-1,-1], false, function(e) { e.execCommand("insertorderedlist"); } ],
    unorderedlist: [ "Bulleted List", ["ed_list_bullet.gif",-1,-1], false, function(e) { e.execCommand("insertunorderedlist"); } ],
    insertorderedlist: [ "Ordered List", ["ed_list_num.gif",-1,-1], false, function(e) { e.execCommand("insertorderedlist"); } ],
    insertunorderedlist: [ "Bulleted List", ["ed_list_bullet.gif",-1,-1], false, function(e) { e.execCommand("insertunorderedlist"); } ],

    outdent: [ "Decrease Indent", ["ed_indent_less.gif",-1,-1], false, function(e) { e.execCommand("outdent"); } ],
    indent: [ "Increase Indent",["ed_indent_more.gif",-1,-1], false, function(e) { e.execCommand("indent"); } ],
    forecolor: [ "Font Color", ["ed_color_fg.gif",-1,-1], false, function(e) { e.execCommand("forecolor"); } ],
    hilitecolor: [ "Background Color", ["ed_color_bg.gif",-1,-1], false, function(e) { e.execCommand("hilitecolor"); } ],

    undo: [ "Undoes your last action", ["ed_undo.gif",-1,-1], false, function(e) { e.execCommand("undo"); } ],
    redo: [ "Redoes your last action", ["ed_redo.gif",-1,-1], false, function(e) { e.execCommand("redo"); } ],
    cut: [ "Cut selection", ["ed_cut.gif",-1,-1], false,  function (e, cmd) { e.execCommand(cmd); } ],
    copy: [ "Copy selection", ["ed_copy.gif",-1,-1], false,  function (e, cmd) { e.execCommand(cmd); } ],
    paste: [ "Paste from clipboard", ["ed_paste.gif",-1,-1], false,  function (e, cmd) { e.execCommand(cmd); } ],
    selectall: [ "Select all", ["ed_selectall.gif",-1,-1], false, function(e) {e.execCommand("selectall");} ],

    inserthorizontalrule: [ "Horizontal Rule", ["ed_hr.gif",-1,-1], false, function(e) { e.execCommand("inserthorizontalrule"); } ],
    createlink: [ "Insert Web Link", ["ed_link.gif",-1,-1], false, function(e) { e._createLink(); } ],
    insertimage: [ "Insert/Modify Image", ["image_1.png",-1,-1], false, function(e) { e.execCommand("insertimage"); } ],
    inserttable: [ "Insert Table", ["insert_table.gif",-1,-1], false, function(e) { e.execCommand("inserttable"); } ],

    htmlmode: [ "Toggle HTML Source", ["ed_html.gif",-1,-1], true, function(e) { e.execCommand("htmlmode"); } ],
    toggleborders: [ "Toggle Borders", ["toggle_borders.gif",-1,-1], false, function(e) { e._toggleBorders(); } ],
    print: [ "Print document", ["ed_print.gif",-1,-1], false, function(e) { if(Xinha.is_gecko) {e._iframe.contentWindow.print(); } else { e.focusEditor(); print(); } } ],
    saveas: [ "Save as", ["ed_saveas.gif",-1,-1], false, function(e) { e.execCommand("saveas",false,"noname.htm"); } ],
    about: [ "About this editor", ["",-1,-1], true, function(e) { e.getPluginInstance("AboutBox").show(); } ],
    showhelp: [ "Help using editor", ["",-1,-1], true, function(e) { e.execCommand("showhelp"); } ],

    splitblock: [ "Split Block", "ed_splitblock.gif", false, function(e) { e._splitBlock(); } ],
    lefttoright: [ "Direction left to right", ["ed_left_to_right.gif",-1,-1], false, function(e) { e.execCommand("lefttoright"); } ],
    righttoleft: [ "Direction right to left", ["ed_right_to_left.gif",-1,-1], false, function(e) { e.execCommand("righttoleft"); } ],
    overwrite: [ "Insert/Overwrite", "ed_overwrite.gif", false, function(e) { e.execCommand("overwrite"); } ],

    wordclean: [ "MS Word Cleaner", ["ed_word_cleaner.gif",-1,-1], false, function(e) { e._wordClean(); } ],
    clearfonts: [ "Clear Inline Font Specifications", ["ed_clearfonts.gif",-1,-1], true, function(e) { e._clearFonts(); } ],
    removeformat: [ "Remove formatting", ["ed_rmformat.gif",-1,-1], false, function(e) { e.execCommand("removeformat"); } ],
    killword: [ "Clear MSOffice tags", ["ed_killword.gif",-1,-1], false, function(e) { e.execCommand("killword"); } ]
  };
  ...
  this.iconList = 
  {
    ...
    wysiwygmode : [_editor_url + 'images/ed_html.gif',-1,-1]
  };
...
Xinha.prototype.setMode = function(mode)
{
  ...
  switch ( mode )
  {
    ...
    case "wysiwyg":
      ...
      this._toolbarObjects.htmlmode.swapImage([this.imgURL('images/ed_html.gif'),-1,-1]); 
      this.setCC("textarea");
