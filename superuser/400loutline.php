...
<html lang="en">
  <head>
     ...
     <meta charset="utf-8">
    <title>400 Level Outline - <?php echo DEPARTMENT_NAME;?></title>
  ...
  <body>
   ...
   <?php include_once 'navigations.php';?>
    ...
    <input type ="submit" name ="submit" value ="upload">
          ...
          <div class="hero-unit">
           <h3>Manage 400 Level Outline page for <?php echo DEPARTMENT_NAME;?></h3><br/>
           <?php
              if(isset($_POST['submit'])){
                 
              $update = new ContentController();
              
              $update->setParams2('400loutline','myarea',1);
              $update->save2();
              }
              ?>
              ...
              <form action ="<?php echo $_SERVER['PHP_SELF'];?>" method ="post">
                  ...
                  <textarea class ="ckeditor" id ="myarea" name ="myarea" style ="width: 100%; height: 400px;"> 
                  <?php ContentController::getContent2(1, '400loutline');  
