function FullScreen(editor, args)
{
  ...
  cfg.registerIcon('fullscreen', [_editor_url + cfg.imgURL + 'fullscreen_maximize.gif',-1,-1]);
  cfg.registerIcon('fullscreenrestore', [_editor_url + cfg.imgURL + 'fullscreen_minimize.gif',-1,-1]);
