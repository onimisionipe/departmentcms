...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>500 level Course Outline - <?php echo DEPARTMENT_NAME;?></title>
  ...
  background-image: -webkit-gradient(linear, 0 0, 0 500%, from(#ffffff), to(#f2f2f2));
...
<div class ="hero-unit">
  <?php  homePageController::getbody(1, '500loutline');?>  
