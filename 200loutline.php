...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>200 level Course Outline - <?php echo DEPARTMENT_NAME;?></title>
  ...
  background-image: -webkit-gradient(linear, 0 0, 0 200%, from(#ffffff), to(#f2f2f2));
...
<div class ="hero-unit">
  <?php  homePageController::getbody(1, '200loutline');?>  
