...
<html lang="en">
  <head>
     ...
     <meta charset="utf-8">
    <title>500 Level Curriculum - <?php echo DEPARTMENT_NAME;?></title>
  ...
  <body>
   ...
   <?php include_once 'navigations.php';?>
    ...
    <input type ="submit" name ="submit" value ="upload">
          ...
          <div class="hero-unit">
           <h3>Manage 500 Level Curriculum page for <?php echo DEPARTMENT_NAME;?></h3><br/>
           <?php
              if(isset($_POST['submit'])){
                 
              $update = new ContentController();
              
              $update->setParams2('500lcur','myarea',1);
              $update->save2();
              }
              ?>
              ...
              <form action ="<?php echo $_SERVER['PHP_SELF'];?>" method ="post">
                  ...
                  <?php ContentController::getContent2(1, '500lcur');  
